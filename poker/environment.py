...
class HoldemEnvironment:
    ...
    def __init__(self, *, button_seat: int = 0, starting_stack: int = 10_000) -> None:
        self.button_seat = button_seat
        self.starting_stack = starting_stack
        self.state: HandState | None = None

    def reset(self, *, seed: int | None = None) -> dict:
        self.state = HandState(seed=seed, button_seat=self.button_seat, starting_stack=self.starting_stack)
